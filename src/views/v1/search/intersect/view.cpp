...
class SearchIntersectHandler final
 ...
 public:
  static constexpr std::string_view kName = "handler-v1-search-intersect";

  SearchIntersectHandler(
...
void AppendSearchIntersect(userver::components::ComponentList& component_list) {
  component_list.Append<SearchIntersectHandler>();
}
