...
namespace views::v1::documents::remove {
...
class DocumentsRemoveHandler final
    : public userver::server::handlers::HttpHandlerBase {
 public:
  static constexpr std::string_view kName = "handler-v1-documents-remove";

  DocumentsRemoveHandler(
 ...
 private:
  ...
  void SendNotifications(
    ...
    const std::vector<DocumentsChainMetadataItemPg>& chain_metadata) const {
        ...
        notification_text = fmt::format("Документ '{}' был удален пользователем {}.", doc_name, employee_name);
...
void AppendDocumentsRemove(userver::components::ComponentList& component_list) {
  component_list.Append<DocumentsRemoveHandler>();
}
