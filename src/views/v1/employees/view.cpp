...
class EmployeesHandler final : public userver::server::handlers::HttpHandlerBase {
 public:
  static constexpr std::string_view kName = "handler-v1-employees";

  EmployeesHandler(const userver::components::ComponentConfig& config,
  ...
  std::string HandleRequestThrow(
    ...
    EmployeesResponse response{result.AsContainer<std::vector<ListEmployee>>(userver::storages::postgres::kRowTag)};
