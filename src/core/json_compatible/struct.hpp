...
public:
    ...
    JsonCompatible& operator=(JsonCompatible&&) {
        return *this;
    }
...
template <class T>
inline void Dump(const T& /*field*/,  const std::string& /* parameter_name */, nlohmann::json& /*json*/) {
...
template <>
inline void Parse(JsonCompatible* res, const nlohmann::json& json) {
...
template <>
inline void Dump(const std::string& field, const std::string& parameter_name, nlohmann::json& json) {
    json[parameter_name] = field;
}

template <>
inline void Dump(const std::vector<std::string>& field, const std::string& parameter_name, nlohmann::json& json) {
    json[parameter_name] = field;
}

template <>
inline void Dump(const JsonCompatible& field, const std::string& parameter_name, nlohmann::json& json) {
    json[parameter_name] = field.ToJson();
}

template <DerivedFromJsonCompatible T>
inline void Dump(const std::vector<T>& field, const std::string& parameter_name, nlohmann::json& json) {
...
void JsonCompatible::RegisterDumping(T* ptr, std::string parameter_name, bool mandatory) {
    LOG_INFO() << "Registering dumping for " << parameter_name;
